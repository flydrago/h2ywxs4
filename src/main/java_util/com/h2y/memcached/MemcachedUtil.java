...
public class MemcachedUtil {
    ...
    public boolean add(String key, Object value, long time) {
        ...
        return memCachedClient.add(MemcachedConn.keyFlg + key, value, expiryTime(time));
    }
     ...
     * @return
     */
    public boolean add(String key, Object value, int flg) {
    ...
    public boolean update(String key, Object value, long time) {
        ...
        return memCachedClient.replace(MemcachedConn.keyFlg + key, value, expiryTime(time));
    }
     ...
     * @return
     */
    public boolean update(String key, Object value, int flg) {
