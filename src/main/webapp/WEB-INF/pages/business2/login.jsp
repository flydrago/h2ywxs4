...
<script type="text/javascript" src="<%=uiPath%>business2/js/login.js"></script>
<title>登录</title>
</head>
	...
	<div style="position:absolute;top:45px;width:100%;overflow-y:auto;overflow-x:hidden;bottom:0px;">
		...
		<ul class="list-group" style="margin-top:10px;margin-bottom:10px;">
			<li class="list-group-item" style="padding-top:7px;padding-bottom:7px;">
				<table style="width:100%;">
					<tr>
						<td style=""><input id="accountInput" type="number" oninput="judgeIfGetCode(this)" placeholder="请输入手机号"  style="width:100%;height:30px;border:none;background:#fff;text-overflow:ellipsis;"/></td>
			...
			<li class="list-group-item" style="padding-top:7px;padding-bottom:7px;">
				<table style="width:100%;">
					<tr>
						<tr>
						<td style="">
						<input id="veriCodeInput" type="password" oninput="forbidBlank()" placeholder="请输入验证码" style="width:100%;height:30px;border:none;background:#fff;text-overflow:ellipsis;"/>
						</td>
						<td style="width:105px;min-width:105px;max-width:105px;text-align:right;">
						<button id="getCodeBtn" class="btn" onclick="getAuthCode(this)" disabled="disabled" style="width:105px;min-width:105px;max-width:105px;background:#0062B6;color:#FFF;">获取验证码</button>
						</td>
					</tr>
				</table>
			</li>
		...
		<div style="width:95%;margin-left:auto;margin-right:auto;margin-top:15px;color:blue;">
			<span class="pull-left" onclick="goToRegisterInterface()">手机快速注册</span>
			<span class="pull-right" onclick="goToMyPwdLoginInterface()">密码登陆</span>
		</div>
	</div>
