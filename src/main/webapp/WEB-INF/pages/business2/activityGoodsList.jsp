...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=uiPath%>business2/js/activityGoodsList.js"></script>
		<title>促销商品列表</title>
	</head>
	...
	<body style="width:100%;height:100%;" >
		...
		<div style="position:absolute;background:#1a90f0;width:100%;height:45px;z-index:3;">
			<table style="width:100%;margin-top:5px;">
				<tr >
					<!-- 公司logo -->
					<td onclick="_goBack()" style="width:35px;padding-left:5px;">
						<img src="<%=uiPath%>business2/images/goBack.png" width="16px" />
					</td>
					<!-- 搜索框 -->
					<td style="padding-left:5px;padding-right:5px;">
						<input type="text" class="homeTitleInput" readonly="readonly" placeholder="搜索商品" onclick="goGoodsSearchInterface()" style="width:100%;height:35px;border:none;padding-left:28px;background-image:url(<%=uiPath%>business2/images/search.png);background-size:22px 22px;background-repeat:no-repeat;background-position:3px center;" />
					</td>
					<!-- 列表显示样式切换 -->
		...
		<!-- 综合 价格 销量 排序显示  -->
		<div id="rankTypediv" style="position:absolute;top:45px;width:100%;background:#ebf2fc;height:40px;z-index:3;">
		...
		<table style="width:100%;display:none">
			...
			<tr>
				<td class="tdRightBorder" id="line_two_template" data-list-per="perItem"  style="width:50%;border-bottom:1px solid #e7e7e7;">
					...
					<!--http://bmg.jydapp.com:82/fp/image/show.htm?path=/opt/h2y/fuf/upload/fileuploadroot_path/201412/52/-1098480328/logo2_20141223003305940.jpg  -->
					<div style="margin-left:8px;margin-bottom:5px;">
						...
						<p style="color:red;font-weight:bold;margin-top:2px;margin-bottom:2px;">
							<span data-priceName="priceName">活动价:</span>
		...
		<!-- 列表 -->
		<div id="listDataDiv" style="position:absolute;top:85px;width:100%;overflow-y:auto;bottom:66px;margin-bottom:20px;">
			...
			<div style="width:100%;text-align:center;margin-top:20px;">
				...
				<button id="bottomMoreBtn" class="btn" onclick="lookMoreGoods()"style="width:98%;height:40px;color:#FFF;font-size:16px;background:#ef4e3a;border-color:#cc2311">点击查看更多</button>
				<span id="noMoreDataWarning" class="badge" style="display:none;background:red;line-height:30px;">没有更多数据!</span>
			</div>
		</div>
		
		<div id="noDataDiv" style="position:absolute;display:none;width:100%;top:50px;text-align:center;color:red">
			<span></span>
		</div>
		</div>
	</body>
